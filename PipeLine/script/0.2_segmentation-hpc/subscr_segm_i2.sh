...
#--raise-on-error 
yaltai kraken --verbose -I "content/image_2/*.jpeg" --alto --suffix ".xml" segment --yolo Layout-16th-Print-Lat.pt

# ALTO XML POST-PROCESSING
# Normalize and fix ALTO file endings (ensure proper </alto> closing tag)
python segmentation-hpc/debug_alto_i2.py

# Update <FileName> field to match the corresponding image filename (.jpg)
python segmentation-hpc/change_xml_file_name2_i2.py

# Rename label "default" to "DefaultLine" for schema consistency
python segmentation-hpc/change_defaultline_i2.py

# add id for BlockZone and textLine
python segmentation-hpc/lxml_altoid_i2.py

# ARCHIVING RESULTS
# Create a ZIP archive containing all segmented ALTO XML files
zip -r altos_segmented2.zip content/image_2/*xml
